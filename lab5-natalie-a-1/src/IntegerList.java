...
public class IntegerList {
	...
	public IntegerList(int capacity) {
		...
		if (capacity < MIN_CAPACITY) {
			...
			String message = "The capacity cannot be less than 2.";
	...
	/**
	 * Return the first index of the given integer if it is in the list; otherwise,
	 * return -1
	 * 
	...
	/**
	 * Insert the given integer at the given index in the list. Shift the existing
	 * integers to the right to make room.
	 * 
	...
	/**
	 * Return a String representation of the list with "[" as the prefix, "]" as the
	 * suffix, and ", " as the delimiter between integers.
	 */
	@Override
	public String toString() {
		...
		for (int i = 0; i < size(); i++) {
			...
			temp2[i] = String.valueOf(temp1[i]);
